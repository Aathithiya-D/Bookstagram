...
function AdminFooter() {
  ...
  <p className="mb-4 mr-4">Quickies : 
    <Link to="/adminpolicy" className="text-gray-300 hover:text-white hover:underline mx-2">
      Privacy Policy
    </Link>
    <Link to="/adminfaq" className="text-gray-300 hover:text-white hover:underline mx-2">
      FAQ's
    </Link>
    <Link to='/adminterms' className="text-gray-300 hover:text-white hover:underline mx-2">
